...
public class InitResponsabileReparto { //TODO riferimento a reparto
    ...
    public void fillTableResponsabileReparto() throws SQLException {
        db.doQuery("INSERT INTO `ResponsabileReparto` (`matricola`,`nome`, `cognome`, `dataNascita`,`via`, `nCivico`, `comune`,`citta`, `comuneDiNascita`, `password`, `ruolo`) VALUES "
                + "('4253', 'Fabio', 'Bianchi', STR_TO_DATE('10/05/1986', '%d/%m/%Y'), 'via Roveggia', '2', 'Verona','Verona','Verona', '1234', 'Frutta'),"
                + "('8659', 'Roberta', 'Guerra', STR_TO_DATE('30/05/1965', '%d/%m/%Y'), 'Via Guglielmo Marconi ', '5', 'Recoaro Terme','Vicenza','Vicenza', 'ciao', 'Panetteria');");
