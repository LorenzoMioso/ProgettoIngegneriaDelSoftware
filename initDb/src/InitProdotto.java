...
public class InitProdotto {
    ...
    public void fillTableProdotto() throws SQLException, FileNotFoundException {
        db.doQuery("INSERT INTO `Prodotto` (`id`, `nome`, `marca`,`immagine`, `tipo`, `reparto`, `inVendita`, `peso`,`nPezzi`, `prezzo`) VALUES "
                ...
                + "(NULL, 'Schiacciatine', 'marca', NULL, 'Uova', 'Panetteria', '1', '1000.0', '5', '3'),"
                + "(NULL, 'Baguette', 'marca', NULL, 'Uova', 'Panetteria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Salatini', 'mar111ca', NULL, 'Uova', 'Panetteria', '1', '1000.0', '5', '6'),"
                ...
                + "(NULL, 'Spaghetti', 'marca', NULL, 'Pasta', 'Pastificio', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Fusilli', 'marca12', NULL, 'Pasta', 'Pastificio', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Gnocchi', 'marca', NULL, 'Pasta', 'Pastificio', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Linguine', 'marca', NULL, 'Pasta', 'Pastificio', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Penne', 'marca33', NULL, 'Uova', 'Pastificio', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Ketchup', 'marca', NULL, 'Uova', 'Sughi e Salse', '1', '1000.0', '5', '11'),"
                ...
                + "(NULL, 'Salsa di soia', 'maradawdca', NULL, 'Uova', 'Sughi e Salse', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Latte Fresco', 'marca', NULL, 'Latte', 'Latteria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Grana', 'marca12', NULL, 'Uova', 'Latteria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Latte scremato', 'marca', NULL, 'Latte', 'Latteria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Caciotta', 'marca', NULL, 'Uova', 'Latteria', '1', '1000.0', '5', '1'),"
                + "(NULL, 'Stracchino', 'marca', NULL, 'Uova', 'Latteria', '1', '1000.0', '5', '1'),"
                ...
                + "(NULL, 'Strutto', 'marca12', NULL, 'Uova', 'Macelleria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Wurstel', 'marca', NULL, 'Uova', 'Macelleria', '1', '1000.0', '5', '43'),"
                + "(NULL, 'Acciughe', 'marcwdwadwdwa', NULL, 'Uova', 'Pescheria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Tonno', 'marca', NULL, 'Uova', 'Pescheria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Salmone', 'marca', NULL, 'Uova', 'Pescheria', '1', '1000.0', '5', '123'),"
                + "(NULL, 'Gamberi', 'marca12', NULL, 'Uova', 'Pescheria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Sgombro', 'marca', NULL, 'Uova', 'Pescheria', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Lasagne', 'maddrca', NULL, 'Uova', 'Gastronomia', '1', '1000.0', '5', '1'),"
                + "(NULL, 'Polenta', 'marca', NULL, 'Uova', 'Gastronomia', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Insalata russa', 'marca', NULL, 'Uova', 'Gastronomia', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Fritto misto', 'marca12', NULL, 'Uova', 'Gastronomia', '1', '1000.0', '5', '2'),"
                ...
                + "(NULL, 'Carote', 'marca12', NULL, 'Uova', 'Verdura', '1', '1000.0', '5', '2'),"
                + "(NULL, 'The', 'marca', NULL, 'Uova', 'Bevande', '1', '1000.0', '5', '2'),"
                + "(NULL, 'Coca Cola', 'mawdwdarca', NULL, 'Uova', 'Bevande', '1', '1000.0', '5', '2'),"
                ...
                + "(NULL, 'Aperol', 'marca12', NULL, 'Uova', 'Vini e Liquori', '1', '1000.0', '5', '2'),"
                ...
                + "(NULL, 'Aceto di vino', 'marca12', NULL, 'Uova', 'Oli e aceti', '1', '1000.0', '5', '2'),"
